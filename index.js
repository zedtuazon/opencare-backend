  ...
  return `
    <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: auto;">
      <div style="text-align: center; margin-bottom: 12px;">
        <img src="${logoUrl}" alt="Opencare Logo" style="height: 90px; display: block; margin: 0 auto;" />
      </div>

      <hr style="border: none; border-top: 4px solid #004080; margin: 0 0 20px 0; width: 100%;" />

      <div style="text-align: left;">
        <h2 style="color: #003366; margin-bottom: 12px;">Survey Responses</h2>
        ...
        <h2 style="color: #003366; margin-top: 30px; margin-bottom: 12px;">Recommended Training Materials</h2>
        <ul>
        ...
        <p style="margin-top: 20px;">If you have any questions, please don't hesitate to respond to this email.</p>
      </div>
    </div>
  `;
}
